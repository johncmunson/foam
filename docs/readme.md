...
After setting up the repository, head to [getting started](docs/getting-started.md) to get familiar with your new knowledge base!
...
- [inbox](docs/inbox.md) - a place to write down quick notes to be categorized later
- [getting-started](docs/getting-started.md) - learn how to use your Foam workspace
